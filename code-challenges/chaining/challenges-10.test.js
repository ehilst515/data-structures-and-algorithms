...
const createServer = () => {
    ...
    app.get('/aboutMe', (request, response) => response.send('My name is Enrique Hilst.'));
    app.get('/favoriteFoods', (request, response) => response.send(['ruben sandwich', 'pizza', 'steak', 'honeydew','bananas foster']));
...
const divisibleByFiveTwoToThePower = (input) => {
    return input.map(array => array.filter(value => typeof(value) !== 'string'))
